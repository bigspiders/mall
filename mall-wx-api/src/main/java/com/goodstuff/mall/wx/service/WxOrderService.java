...
import com.goodstuff.mall.core.express.ExpressService;
import com.goodstuff.mall.core.express.dao.ExpressInfo;
...
import com.goodstuff.mall.core.system.SystemConfig;
import com.goodstuff.mall.core.util.DateTimeUtil;
import com.goodstuff.mall.core.util.JacksonUtil;
import com.goodstuff.mall.core.util.ResponseUtil;
import com.goodstuff.mall.db.domain.*;
import com.goodstuff.mall.db.service.*;
import com.goodstuff.mall.db.util.CouponUserConstant;
import com.goodstuff.mall.db.util.OrderHandleOption;
import com.goodstuff.mall.db.util.OrderUtil;
import com.goodstuff.mall.wx.util.FreeFreightUtils;
...
public class WxOrderService {
    ...
    public Object submit(Integer userId, String body) {
        ...
        //测试商品免运费
        if(FreeFreightUtils.isFreeFreight(checkedGoodsList)){
